<template>
  <div class="flex-justify_center index_wrapper">
    <div class="bg-panel">
      <img src="/img/indexIcon.png" style="position:absolute;margin-left:-143px;margin-top:89px;"/>
    </div>
    <div class="input-panel">
      <el-container>
        <el-main style="height:458px;padding-top:120px;">
          <img src="/img/user.svg" style="position:absolute;width:25px;height:27px;margin-left:-173px;margin-top:7px;"/>
          <img src="/img/password.svg" style="position:absolute;width:26px;height:22px;margin-left:-173px;margin-top:70px;"/>
